...
import kb2 from "../Images/kb2.webp";
import Carousel from 'react-bootstrap/Carousel';
const EthnicSetswithDupatta=()=>{
return(
    <>
  
    <h1 style={{color:"red",fontSize:"20px"}}>Ethnic Sets for Women</h1>
      <Carousel>
      <Carousel.Item interval={1000}>
        <img src={kb2} width="100%" height="400" alt="First slide" />
        <Carousel.Caption>
    ...
    color: "orange", textAlign: "center" ,hover:"voilet"}}>Ethnic Sets Collections</h1>
...
export default EthnicSetswithDupatta;